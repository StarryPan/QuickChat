        ...
        listen: function (options) {
            $('body').on('click', '[data-bgcolor]', function () {
                ...
                var html = '<div class="layuimini-color">\n' +
                    ...
                    '<a class="more-menu-item" href="javascript:;"><i class="layui-icon layui-icon-read" style="font-size: 19px;"></i> 语言（简体中文）</a>\n' +
            ...
            $('body').on('click', '[data-select-bgcolor]', function () {
                ...
                $.ajax({
                    url: miniTheme.url('ajax/saveBgColorId'),
                    type: 'post',
                    ...
                    error: function (xhr, textstatus, thrown) {
                        layer.msg('保存主题失败', {icon: 2, anim: 0, shade: [0.02, '#000'], scrollbar: false, time: 3500, shadeClose: true});
                    }
                });
            });
        }
